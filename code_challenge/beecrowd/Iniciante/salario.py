...
decimais, representando o número, quantidade de horas trabalhadas e o valor que o funcionário 
...
days_works = int(input())
day_money = int(input())
hours_money = float(input())

print(f'NUMBER = {days_works}')
print(f'SALARY = U$ {hours_money * day_money:.2f}')